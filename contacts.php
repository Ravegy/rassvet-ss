...
<head>
    ...
    <link rel="stylesheet" href="pages/contacts/style.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-status">
                <span class="status-dot"></span> ВСЕГДА НА СВЯЗИ
            </div>
        </div>
                ...
                <div class="tech-card departments-card">
                    ...
                    <div class="dept-item">
                        <div class="dept-head">
                            ...
                            <span class="dept-status">Sales</span>
                        </div>
                    ...
                    <div class="dept-item">
                        <div class="dept-head">
                            <span class="dept-name">СЕРВИСНАЯ СЛУЖБА</span>
                            <span class="dept-status">Service</span>
                        </div>
                    ...
                    <div class="dept-item">
                        <div class="dept-head">
                            <span class="dept-name">БУХГАЛТЕРИЯ</span>
                            <span class="dept-status">Docs</span>
                        </div>
            ...
            <div class="contacts-map-col">
                ...
                <div class="tech-card form-card">
                    ...
                    <form class="contact-form">
                        ...
                        <textarea class="c-input c-area" placeholder="Текст сообщения или список запчастей..." rows="3"></textarea>
...
<script src="pages/contacts/script.js"></script>
</body>
</html>
